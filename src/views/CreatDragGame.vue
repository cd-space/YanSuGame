    ...
    <div class="middle">
            ...
            <tr>
              <th v-for="n in tableStore.columns" :key="`header-${n}`" class="th-head">
                <div style="display: flex;">
                  <input type="text" v-model="tableStore.headers[0][n - 1]" :placeholder="n === 1 ? '| 首列标题' : `| 表头`"
                    style="font-size:clamp(10px, 3.4vw, 20px);" />
          ...
          <div class="random-checkbox">
            <label style="display: flex; justify-content: center; align-items: center;">
              <input type="checkbox" v-model="tableStore.shuffleAnswers"
                style="width: 15px; height: 15px; margin: 3px;" />
              允许设置在预览中随机打乱答案顺序
            </label>
          </div>
        </div>
      ...
      <div class="box">
        <div class="theme-setting">
          ...
          <pick-colors v-model:value="tableStore.themeColor" show-alpha :colors="colors" :width="60"
