  ...
  <div class="game-container">
        ...
        <tr v-for="(row, rowIndex) in tableData" :key="rowIndex">
          ...
          <td v-for="(cell, colIndex) in row.slice(1)" 
            ...
            <span v-if="filledAnswers[rowIndex] && filledAnswers[rowIndex][colIndex]" 
                  ...
                  @touchstart.prevent="onTouchStart(filledAnswers[rowIndex][colIndex], rowIndex, colIndex)">
    ...
    <div class="options" @drop="onDropBack($event)" @dragover.prevent>
      <div 
        ...
        @touchstart.prevent="onTouchStart(option)">
        {{ option }}
      </div>
    </div>
  </div>
...
const onTouchStart = (item, rowIndex = null, colIndex = null) => {
  draggedItem.value = item;
  draggedFrom.value = { rowIndex, colIndex };
};
